"""
Script that collects tag synonyms from Stackoverflow and puts them into a database
careful when using the stackexchange api -  if you perform more than 30 requests/minute 
the api will cut you off just like Simba was by Scar

...
stackSearchResults = site.search(tagged="C++",fromdate = str(int(simpledate.SimpleDate('2014-04-01',tz='UTC').timestamp)),
	todate=str(int(simpledate.SimpleDate('2014-05-01',tz='UTC').timestamp)))

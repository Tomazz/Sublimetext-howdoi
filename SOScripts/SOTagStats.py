...
"""Script that collects the full content of questions returned by the query
   Given a JSON file with tag data of form {tag:tagcount}
   produce a pygal barchart
"""
...
tagsDict = _readJSONQuestionsToDict(dataDirectory)
_drawABarChart(tagsDict,directory)
